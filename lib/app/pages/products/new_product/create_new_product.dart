...
class _CreateNewProductState extends State<CreateNewProduct> {
  ...
  Map<String,FaIcon> categoriesIcons={
    ...
    "Carnes": FaIcon(FontAwesomeIcons.drumstickBite,),
    ...
    "Bebidas":FaIcon(FontAwesomeIcons.tint,),
    ...
    "Congelados":FaIcon(FontAwesomeIcons.solidSnowflake),
    ...
    "Electrónica y electrodomésticos":FaIcon(FontAwesomeIcons.desktop),
    "Papelería":FaIcon(FontAwesomeIcons.paperclip),
    "Pescados y mariscos":FaIcon(FontAwesomeIcons.fish),
    "Ropa":FaIcon(FontAwesomeIcons.tshirt),
    "Salud y belleza":FaIcon(FontAwesomeIcons.airFreshener),
    "Libros y música":FaIcon(FontAwesomeIcons.bookOpen),
  };
